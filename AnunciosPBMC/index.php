		   ...
		   <?php require ('controller/FechaController.php');?>
            ...
            <ul class="ListaC">
				<?php while ($colum = sqlsrv_fetch_array($result))
					{
						if($colum[0]== 8){
							echo '<li class="flow">3 YESLLY JIMENEZ DURAN.</li>';
							$manejador_archivo->guardarRegistroCumpleanios("3 YESLLY JIMENEZ DURAN\n");
						}
						 ?>

								<?php $manejador_archivo->guardarRegistroCumpleanios($colum[0]." ".$colum[1]."\n");?>
						...
						<?php } ?>
						<?php $manejador_archivo->cerrarArchivo();?>
